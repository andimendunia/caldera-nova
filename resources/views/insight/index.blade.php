                    ...
                    <div class="flex">
                        <div>
                            <div class="relative flex w-32 h-full bg-neutral-200 dark:bg-neutral-700">
                                ...
                                <img class="absolute w-full h-full object-cover dark:brightness-75 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" src="/ins-acm.jpg" />
                            </div>            
                        </div>
                        <div class="flex grow py-4 px-2 sm:p-6">
                            <div class="grow">
                                ...
                                <div class="text-sm text-neutral-600 dark:text-neutral-400">
                                    {{ __('Sistem monitoring konveyor untuk mencatat kecepatan konveyor yang terletak di proses assembly.') }}
                                </div>
                            </div>
                        </div>
                    </div>
