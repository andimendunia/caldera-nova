<nav x-data="{ open: false }" class="bg-white dark:bg-neutral-800 border-b border-neutral-100 dark:border-neutral-700">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @can('viewAny', App\Models\InvItem::class)
                <x-responsive-nav-link :href="route('inventory')" :active="request()->is('inventory*')">
                    {{ __('Inventaris') }}
        ...
        <div class="py-4 border-t border-neutral-200 dark:border-neutral-600">
            @if (Auth::user())
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('prefs')" :active="request()->is('prefs*')">
                        {{ __('Preferensi') }}
                    </x-responsive-nav-link>
