    ...
    <div class="flex flex-col gap-x-4 md:gap-x-8 sm:flex-row">
        <div>
            <div class="w-full sm:w-44 md:w-56 px-3 sm:px-0 mb-10">
                ...
                <div class="m-3">
                    <x-checkbox id="inv-area-1" class="mb-4">TT MM</x-checkbox>
                    <x-checkbox id="inv-area-2" class="mb-4">TT MM Cons</x-checkbox>
                    <x-checkbox id="inv-area-3" class="mb-4">TT Maintenance</x-checkbox>
                </div>
