<div class="block sm:flex gap-x-6">
    ...
    <div class="w-full overflow-hidden">
        ...
        <livewire:inv-item-circ :qty_main="$inv_item->qty_main" :qty_used="$inv_item->qty_used" :qty_rep="$inv_item->qty_rep" :curr="$inv_curr->name" :price="$inv_item->price" :uom="$inv_item->inv_uom->name" />
    </div>
</div>
