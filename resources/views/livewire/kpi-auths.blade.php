<div>
    <div class="w-full mt-5">
        ...
        <x-modal name="create-auth">
            <livewire:kpi-auths-form wire:key="auths-create" lazy />
        </x-modal>
        <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg mt-5">          
            <div class="flex items-center justify-between px-6 py-3">
                ...
                <div class="w-40">
                    <x-text-input-search wire:model.live="q" id="kpi-q" placeholder="{{ __('CARI') }}"></x-text-input-search>
                </div>
            </div>  
            ...
            <table wire:key="auths-table" class="table">
                ...
                <x-modal :name="'edit-auth-'.$auth->id">
                    <livewire:kpi-auths-form wire:key="auth-lw-{{ $auth->id . $loop->index }}" :auth="$auth" lazy />                    
                </x-modal> 
                @endforeach
            </table>
