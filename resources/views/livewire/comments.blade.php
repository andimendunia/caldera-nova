<div class="pb-32">
    ...
    <div class="flex gap-x-4 my-6">
        ...
        <div x-data="{ openReply: false }" class="w-full">
            ...
            <hr class=" border-neutral-200 dark:border-neutral-800 mt-6" />
            <div class="flex gap-x-4 my-6">
                <div>
                    <div class="w-8 h-8 bg-neutral-200 dark:bg-neutral-700 rounded-full overflow-hidden">
                        @if ($child->user->photo)
                ...
                <div class="w-full">
                    ...
                    <div class="text-neutral-400 dark:text-neutral-600 text-sm mt-2">
                        <x-text-button type="button" x-on:click="openReply = true">{{ __('Balas') }}</x-text-button>
                    </div>                    
                </div>
            </div>
            @endforeach
            <div x-show="openReply" x-cloak>
                <livewire:com-item-write :mod="$child" lazy />
            </div>
        </div>
    </div>
