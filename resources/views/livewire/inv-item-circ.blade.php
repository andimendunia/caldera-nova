<div x-data="{
    ...
    get qty_main() {
        return this.calcQty(1, {{ $qty_main }});
    },
    get qty_used() {
        return this.calcQty(2, {{ $qty_used }});
    },
    get qty_rep() {
        return this.calcQty(3, {{ $qty_rep }});
    }
    }">
    <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg">
        ...
        <div x-show="parseInt(qty) === 0 || qty > 0 || qty < 0" x-cloak class="px-4 pb-5">
            ...
            <x-text-input id="inv-remarks" class="mt-3" name="remarks" type="text"
            ...
            <x-primary-button md x-show="qtype" type="button"
                x:on-click.prevent="notyf.success('Sirkulasi dibuat');" class="w-full flex justify-center mt-4">
